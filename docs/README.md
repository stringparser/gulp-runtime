# Thy docs[<img alt="progressed.io" src="http://progressed.io/bar/43" align="right"/>](https://github.com/fehmicansaglam/progressed.io)
...
Assign completion for that node of the `command` object.
