...
var RuntimeWarning = require('../util/RuntimeWarning')
...
listen.next = function(cmd, args, index){
  ...
  handle.call(this, cmd, args, index, function (){
    ...
    if(cmd)
      ...
      this.emit('done', cmd, args, index+1);
  })
...
function handle(cmd, args, index, callback){
  ...
  if(this.handle){
    ...
    RuntimeWarning.call(this, function(){
